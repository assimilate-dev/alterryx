...
*KNOWN ISSUE WITH SEARCH PARAMETER*
Using the `search` parameter for the `get_app` function is currently not
not working. This is an issue with the Alteryx Gallery API and not this
package.
